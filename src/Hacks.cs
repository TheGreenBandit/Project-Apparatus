...
namespace ProjectApparatus
{
        ...
        private Dictionary<string, string> availableLanguages = new Dictionary<string, string>
    {
        ...
        public void OnGUI()
        {
            ...
            if(Settings.Instance.settingsData.b_DisplayWaterMark)
        ...
        public string objToSpawn = "Object To Spawn";
        public int objScrapValue = 0;
        private void MenuContent(int windowID)
        {
            ...
            UI.TabContents(GetString("self"), UI.Tabs.Self, () =>
            {
                ...
                UI.Button($"Spawn Object: {objToSpawn}", "Must be host to use, don't use spaces. Examples include BigBolt, MetalSheet, Key", () =>
                ...
                UI.Button($"Set Held Item Scrap Value: {objScrapValue}", "", () => { Instance.localPlayer.currentlyHeldObjectServer.SetScrapValue(objScrapValue); });
                ...
                UI.Keybind(Features.Instance.exampleFeature, ref settingsData.keyExampleFeature);
                ...
                {
                    Features.Instance.selfRevive.Action();
                });
            ...
            {
                UI.Checkbox(ref settingsData.b_DisplayWaterMark, GetString("display_watermark"), GetString("display_watermark_desc"));
